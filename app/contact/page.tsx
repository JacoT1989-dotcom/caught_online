      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Card className="p-6 bg-[#25D366] text-white">
            <div className="text-center space-y-4">
              ...
              <p className="text-white/90">
                Get instant responses from our AI assistant, available 24/7 to Shop, help with orders, give product information, and more including recipe ideas and inpiration.
              </p>
              <Button 
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Cape Town, Johannesburg, Pretoria, Durban</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">sales@caughtonline.co.za</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
        ...
        <Card className="mt-8 p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-[#f6424a] hover:bg-[#f6424a]/90">
              Send Message
            </Button>
          </form>
        </Card>
