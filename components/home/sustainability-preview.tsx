    ...
    <section className="px-2 md:px-8 py-6 sm:py-8">
      <div className="relative rounded-xl border overflow-hidden">
        ...
        <div className="relative z-10 px-8 py-16 md:py-24 lg:py-32 max-w-2xl text-white">
          <Badge className="mb-4 bg-[#f6424a] text-white border-none">Our Commitment</Badge>
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Sustainable Fishing Practices</h2>
