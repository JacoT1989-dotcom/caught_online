              ...
              <div className="w-full lg:max-w-xl space-y-3 lg:space-y-4">
                ...
                <div className="text-center lg:text-left space-y-2">
                  ...
                  <p className={cn(
                    ...
                    Pre-Portioned restaurant quality seafood delivered straight to your door in Cape Town, Johannesburg, Pretoria, and Durban!
                  </p>
                </div>

                {/* Mobile Video */}
                <div className="block lg:hidden relative w-full aspect-[4/3] rounded-lg overflow-hidden">
                  <video
                    autoPlay
                    loop
                    muted
                    playsInline
                    className="absolute inset-0 w-full h-full object-cover [filter:saturate(1.2)]"
                  >
                    <source 
                ...
                <div className="flex items-center justify-center lg:justify-start gap-2">
                  <div className="flex">
                    {[...Array(5)].map((_, i) => (
                      <span key={i} className="text-base sm:text-xl text-[#41c8d2]">⭐</span>
                    ))}
                  </div>
                  <span className="text-xs sm:text-sm font-semibold">50 000+ Boxes Delivered</span>
                </div>
                ...
                <div className="hidden sm:flex flex-wrap justify-center lg:justify-start gap-2">
                  {[
                    ...
                    <div key={text} className="inline-flex items-center whitespace-nowrap bg-[#41c8d2]/10 rounded-full px-3 py-1.5 border border-[#41c8d2]/20">
                      <Icon className="h-3.5 w-3.5 text-[#41c8d2] flex-shrink-0" />
                      <span className="ml-1.5 text-xs sm:text-sm font-medium">{text}</span>
                    </div>
                  ))}
                </div>
            ...
            <div className="hidden lg:block relative h-[500px]">
              <div className="absolute inset-0 overflow-hidden">
                <video
                  ...
                  muted
                  playsInline
                  className="absolute right-0 w-[120%] h-full object-cover rounded-l-3xl shadow-2xl [filter:saturate(1.2)]"
                >
                  <source 
                    src="https://xbutpndzgqpjnjst.public.blob.vercel-storage.com/Homepage%20Video/Prawn%20Pasta-jGUf98NpB9MiKm54yMIBXyLtB9ooqv.mp4" 
                    type="video/mp4" 
