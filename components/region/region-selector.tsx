...
export function RegionSelector({ 
  ...
  const trigger = children || (
    ...
    >
      ...
      {selectedRegion ? regions.find(r => r.id === selectedRegion)?.name : 'Select Region'}
    </Button>
  );
                ...
                {regions.map((region) => (
                  <Button
                    ...
                    className={cn(
                      ...
                      selectedRegion === region.id && "border-[#f6424a] bg-[#f6424a]/5"
                    )}
                  ...
                  >
                    <div className="flex items-center gap-3 w-full">
                      ...
                      <div className="flex flex-col items-start">
                        ...
                        <span className="text-sm text-muted-foreground">{region.delivery}</span>
                      </div>
                    </div>
                  </Button>
                ))}
