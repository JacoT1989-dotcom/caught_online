...
export const SubscriptionFlowService = {
  ...
  getSubscriptions: async (customerId?: string): Promise<Subscription[]> => {
    try {
      const url = customerId
        ? `/api/subscriptionsflow/subscriptions?customerId=${encodeURIComponent(
            customerId
          )}`
  ...
  getSubscriptionsByEmail: async (email: string): Promise<Subscription[]> => {
    try {
      const url = `/api/subscriptionsflow/subscriptions?email=${encodeURIComponent(
        email
      )}`;
  ...
  getSubscriptionsByCustomerNumber: async (
    ...
    try {
      const url = `/api/subscriptionsflow/subscriptions?customerNumber=${encodeURIComponent(
        customerNumber
      )}`;
